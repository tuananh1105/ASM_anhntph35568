    ...
    return (
        <>
            <div className='bg-gray-100'>
                ...
                <br />
                <div>
                    <div className="grid grid-cols-1  sm:grid-flow-col mx-auto max-w-[2000px]">
                        <div>
                            <div className="bg-white p-4 rounded-lg " style={{ maxWidth: "910px" }}>
                                <h1 className="font-bold text-xl">Thông Tin Liên Hệ</h1>
                                <div className="relative border h-14 mt-4 border-black-500 rounded-lg">
                                    <input className="pt-4 font-semibold mt-3 ml-2 w-full" type="text" value="Nguyễn Tuấn Anh FPL" />
                                    <span className="absolute text-gray-400 left-0 top-0 text-xs mt-1 ml-2">Tên người đi <span className="text-red-600">*</span></span>
                                </div>
                                <div className="flex gap-5">
                                    <div className="border h-14 w-28 mt-4 border-black-500 rounded-lg">
                                        <p className="pt-4 font-semibold ml-6">VN +84</p>
                                    </div>
                                    <div className="relative border h-14 mt-4 border-black-500 rounded-lg flex-grow">
                                        <input className="pt-4 font-semibold mt-3 ml-2 border-0 w-full" type="text" value="335039614" />
                                        <span className="absolute text-gray-400 left-0 top-0 text-xs mt-1 ml-2">Số Điện Thoai <span className="text-red-600 text-xs">*</span></span>
                                    </div>
                                </div>
                                <div className="relative border h-14 mt-4 border-black-500 rounded-lg">
                                    <input className="pt-4 font-semibold mt-3 ml-2 w-full" type="text" value="anhntph35568@fpt.edu.vn" />
                                    <span className="absolute text-gray-400 left-0 top-0 text-xs mt-1 ml-2">Email để nhận thông tin đặt chỗ <span className="text-red-600">*</span></span>
                                </div>
